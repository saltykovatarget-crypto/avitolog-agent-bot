const ROUTES = [
  ...
  { pattern: /разбор объявлени|разбери объявлени|что не так с объявлени/i, agents: ["smm", "editor"], platforms: false, label: "делаю разбор объявления (формат 1)" },
  { pattern: /что.*30 минут|мини.аудит|аудит аккаунта/i, agents: ["smm", "editor"], platforms: false, label: "пишу мини-аудит (формат 2)" },
  { pattern: /скриншот|цифры из кабинета|живые цифры/i, agents: ["smm"], platforms: false, label: "оформляю пост со скриншотом (формат 3)" },
  { pattern: /мне часто пишут|частый вопрос|отвечаю на вопрос/i, agents: ["smm", "editor"], platforms: false, label: "отвечаю на частый вопрос (формат 4)" },
  { pattern: /эксперимент|тестирую|буду показывать результат/i, agents: ["smm"], platforms: false, label: "анонсирую эксперимент (формат 5)" },
  ...
  { pattern: /манифест|разорванн.*петл|архитектура.*видео|хук.*видео|reels.?pro/i, agents: ["reels-pro"], platforms: false, label: "пишу Reels Pro (манифест/хук)" },
  { pattern: /сценари|reels|рилс|видео|shorts|снять|снимать/i, agents: ["reels-pro"], platforms: false, label: "пишу сценарий Reels Pro" },
